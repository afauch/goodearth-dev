...
namespace HoloToolkit.Unity
{
    ...
    public class SimpleYLimitedTagalong : MonoBehaviour
    {
        ...
        protected virtual void Update()
        {
            ...
            {
                // AFAUCH
                // Keep the tagalong from exceeding a certain Y height
                if (tagalongTargetPosition.y > GlobalUISettings.Instance._maximumYTagalong)
                {
                    tagalongTargetPosition.y = GlobalUISettings.Instance._maximumYTagalong;
                }
                // Debug.Log(tagalongTargetPosition);
